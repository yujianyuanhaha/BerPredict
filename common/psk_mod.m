...
% function [sig,rcos] = psk_mod(bitsPerSym, sampsPerSym, eBW, bits)
%
% This function performs psk modulation along with pulse shaping
%
% Inputs
%   bitsPerSym - number of bits per symbol; M = 2^bitsPerSym
%   sampsPerSym - samples per symbol for pulse shape
%   eBW - excess BW for RC pulse shape
%   bits - data bits to be transmitted
%
% Outputs
%   sig - complex samples of the PSK transmit symbols
%   rcos - square root raised cosine pulse shape
