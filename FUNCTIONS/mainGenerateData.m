...
Xname =  strcat('./Data2/X200k',num2str(mID),'.mat')    % name of saved data
Yname =  strcat('./Data2/Y200k',num2str(mID),'.mat')
...
V_bitsPerSym = [1,2];
V_JtoS       = -10 + rand(1,100)*20;
V_EbNo       = 0+rand(1,100)*20;
V_IntfType   = [1,2];
V_duty       = 0.2 + 0.6*rand(1,5);

Nc = 0;
for i1 = 1:Ndat(1)
    bitsPerSym = V_bitsPerSym(i1);
